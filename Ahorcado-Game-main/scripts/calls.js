...
const palabras = ["ALURA", 'HARDWARE', 'SOFTWARE', 'CSS', 'HTML', 'MOUSE','TECLADO','PANTALLA','CODIGO','APRENDER','MESSI','AGREGAR','PAIS','DISCO','CELULAR','POKEMON','CHALLENGE','PIN','AGREGAR','JUEGO']
